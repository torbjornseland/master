...
\begin{equation}
	...
	\end{aligned}
\end{equation}
Now \code{sympy} can be used to do the calculations for the three functions $f$, $g$ and $h$. The program can be seen in the Appendix. This result in the following equations seen in Eq.(\ref{eq:manu_func}) 
