...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/threshold_phenomenon.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/English_boarding_school.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/English_boarding_school_changes.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/WD_zombie_initial_1.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/check_parameters.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/WD_zombie_initial_2.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/check_parameters_hysterical_2.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/WD_zombie_hysterical_1.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/omega_function.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/WD_zombie_counter_1.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/WD_zombie_counter_2.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/WD_zombie_counter_series.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{1_fig/WD_zombie_all_phases_1.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/trav_wave_sub.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{2_fig/epidemic_wave_z_lambda_0_5.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/Trav_wave_2D.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_initial_variable_sub.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/TW_2D_initial_z_lambda_0_5.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.9\linewidth]{2_fig/2D_lambda_variable.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/british_number.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_british_school_gauss_sub.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_zombie_three_phases_number.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/initial_value_susceptible.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_zombie_three_phases_zombie_large_town_2_sub.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_compare_towns.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_compare_Frederikke.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_Frederikke_contourf_sub.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_Frederikke_random_contourf_sub.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_gauss_sub.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_gauss_one_sub.eps}}
  \caption{
...
\begin{center}  % inline figure
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_british_school_sub.eps}}
\end{center}


\paragraph{Gaussian from the corner.}
\begin{center}  % inline figure
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_british_school_gauss_corner_sub.eps}}
\end{center}


\paragraph{A long simulation on 100 Days.}
\begin{center}  % inline figure
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_british_school_long_number.eps}}
\end{center}



\begin{center}  % inline figure
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_british_school_gauss_long_number.eps}}
\end{center}



\begin{center}  % inline figure
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_british_school_gauss_corner_long_number.eps}}
\end{center}
...
\begin{center}  % inline figure
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_zombie_initial_cond_sub.eps}}
\end{center}



\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_zombie_initial_cond_number.eps}}
  \caption{
...
\begin{center}  % inline figure
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_zombie_three_phases_sub.eps}}
\end{center}


\paragraph{middle town.}
\begin{center}  % inline figure
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_zombie_three_phases_zombie_middle_town_surface_sub.eps}}
\end{center}


\paragraph{large town.}
\begin{center}  % inline figure
  \centerline{\includegraphics[width=0.8\linewidth]{2_fig/2D_zombie_three_phases_zombie_large_town_sub.eps}}
\end{center}
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{3_fig/random_compare.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{3_fig/random_walk_days.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{3_fig/english_school_random.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{3_fig/figure_images.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{3_fig/Frederikke_initial_final.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{3_fig/Walking_dead_Frederikke.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{3_fig/Moving_smart_screen.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{3_fig/Moving_smart_average.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{3_fig/three_phases_ODE_sd.eps}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{3_fig/three_phases_random.eps}}
  \caption{
